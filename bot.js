...
setInterval(() => { // CODE BY KAHRBAA كههربا
  http.get(`http://hamaki2-24h.glitch.me/`);
}, 280000);
...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity("YaSmenn up 🌙⚡",{type: 'WATCHING'})
});
// CODE BY KAHRBAA كههربا
const { Client } = require('discord.js');
const ytdl  = require('ytdl-core');// CODE BY KAHRBAA كههربا
const url = 'https://youtu.be/FBo8LCQqODQ'; // هنا فديو الخاص ب القرأن الكريم كامل // CODE BY KAHRBAA كههربا

// CODE BY KAHRBAA كههربا
const { Client } = require('discord.js');
const ytdl  = require('ytdl-core');// CODE BY KAHRBAA كههربا
const url = 'https://youtu.be/VQc613pd-2E'; // هنا فديو الخاص ب القرأن الكريم كامل // CODE BY KAHRBAA كههربا


// CODE BY KAHRBAA كههربا
const { Client } = require('discord.js');
const ytdl  = require('ytdl-core');// CODE BY KAHRBAA كههربا
const url = 'https://youtu.be/oElol6JnT0w'; // هنا فديو الخاص ب القرأن الكريم كامل // CODE BY KAHRBAA كههربا



client.on('ready',async () => {
    console.log('تـم تشغيل الاغنية);
    // CODE BY KAHRBAA كههربا
